...
import type { SelectedConversation } from "../types/conversation.ts";
import ConversationSection from "../components/section/ConversationSection.tsx";
...
const Conversations = () => {
  ...
  return (
    <Page className={"w-full flex overflow-hidden items-center"}>
      ...
      selectedConversation.recipientUsername ? (
        <ConversationSection
          receiverId={selectedConversation.recipientId}
          receiverUsername={selectedConversation.recipientUsername}
        />
      ) : (
        <>
          {" "}
